...
export const metadata: Metadata = {
  ...
  description: 'Information om kiropraktiska behandlingar, vad de kan hjälpa med, och vad du kan förvänta dig vid ett besök hos oss. Lär dig mer om kiropraktik och våra behandlingsmetoder.',
  alternates: {
    canonical: 'https://www.kiro-jkpg.se/behandlingar-kunskap',
  },
};
...
export default function BehandlingarKunskap() {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Vad händer vid första besöket hos kiropraktorn?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Vid första besöket tar vi en grundlig anamnes där vi ställer frågor om ditt problem, hur länge det pågått, och om det hände något speciellt när det började. Vi frågar också om din medicinska historia. Sedan gör vi en undersökning och förklarar vad vi hittar. Allt omfattas av sekretess och tystnadsplikt."
        }
      },
      {
        "@type": "Question",
        "name": "Hur går en kiropraktisk behandling till?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Behandlingen består oftast av tre delar: 1) Lossa på stelheten i lederna genom att sträcka på dem (det kan höras ett knäck), 2) Mjuka upp spända muskler med triggerpunktteknik, 3) Råd och rekommendationer om hur du själv kan bidra till läkning. Behandlingen syftar till att återskapa normal funktion och åtgärda orsakerna till symptomen."
        }
      },
      {
        "@type": "Question",
        "name": "Vad är kiropraktik?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Kiropraktik kommer av de grekiska orden chiros och praktikos, som betyder utövande med händerna. Det är en behandlingsmetod som har existerat i olika former i århundraden. Den moderna kiropraktiken etablerades i slutet av 1800-talet. Behandlingen utförs primärt med händerna för att återskapa rörlighet i leder och minska muskelspänningar."
        }
      },
      {
        "@type": "Question",
        "name": "Vad är Straighten Up Sweden?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Straighten Up Sweden är ett rörelseprogram från Legitimerade Kiropraktorers Riksorganisation (LKR) för att förbättra rygghälsan. Programmet innehåller enkla övningar som tar bara några minuter per dag och är framtaget för alla åldrar. Världshälsoorganisationen stödjer programmet för att det främjar hälsa bland barn och ungdomar."
        }
      }
    ]
  };
